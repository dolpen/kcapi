/**
 * テーブルのヘッダーがfixedっぽくなる
 */
(function ($) {
    $.fn.prepFixedHeader = function () {
        return this.each(function () {
            $(this).wrap('<div class="fixed-table"><div class="table-content"></div></div>');
        });
    };
    ...
    $.fn.fixedHeader = function () {
        return this.each(function () {
            ...
            $table.addClass(o.attr('class') + ' table-copy').removeClass('table-fixed-header')
                .appendTo(nhead)
            ...
            setTimeout(function () {
                var $parent = o.parent();
                $parent.scrollTop($parent.scrollTop() - $head.outerHeight());
            }, 40);
